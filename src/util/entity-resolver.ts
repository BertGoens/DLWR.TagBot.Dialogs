...
export const resolveDateV2 = (entities: builder.IEntity[]) => {
	const dateTime: any = builder.EntityRecognizer.findEntity(entities, 'builtin.datetimeV2.datetime')

	const date: any = builder.EntityRecognizer.findEntity(entities, 'builtin.datetimeV2.date')
